...
public class FingerLogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            if (!fingerprintManager.hasEnrolledFingerprints())
                Toast.makeText(this, "No fingerprints saved", Toast.LENGTH_SHORT).show();
 ...
 @TargetApi(23)  private void generateKey() throws FingerprintException {
        try {
   ...
   @TargetApi(23) public boolean initCipher() {
        try {
